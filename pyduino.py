...
class Arduino():
    ...
    def variable_read(self, variable_number):
        """
        Ask arduino for contents of a variable and returns an untyped value
        Internally sends b'RV{variable_number}' over the serial connection
        assign your variables a fake pin number e.g. 99
        """
